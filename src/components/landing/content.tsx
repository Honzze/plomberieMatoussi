...
export const Content = () => {
  return (
    <div className="sm: mx-auto my-20 flex max-w-7xl flex-row items-center justify-center px-4">
      <h2 className="lg-8 mb-5 text-center text-5xl">NOS SERVICES</h2>
      <div className="sm: flex flex-col items-center justify-center gap-6">
        <Card
